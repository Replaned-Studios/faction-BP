...
declare class ChestFormData {
	 ...
	 */
	button(slot: number, itemName?: string, itemDesc?: string[], texture?: string, stackAmount?: number, enchanted?: boolean, callback?: (slot: number) => void): ChestFormData;
	/**
	...
	*/
	...
	/**
	  ...
	  * @param Way2 - Way 2 is wen the callback in buttons and pattern will work and FormRejectCallBack WihtOut The Promise But if the value is null or empty the show is going to return a Promises
	  * @param FormRejectCallBack - if Way2 is true then this will return any Form Cancelations Reasons and if the form was canceled
	 */
	show(player: Player, Way2 = boolean | null, FormRejectCallBack = (cancelationReason: FormCancelationReason, canceled: boolean) => undefined): Promise<ActionFormResponse> | undefined
}
